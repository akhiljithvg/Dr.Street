...
import cv2
import numpy as np
import serial  # CHANGED: Replaced gpiozero with serial
import time

# ============================================================
#    HARDWARE SETUP
# ============================================================
# CHANGED: Replaced PWM pins with UART Serial connection to ESP32
try:
...
def set_motor(right, left):
    ...
    # CHANGED: Converted the 0.0-1.0 ratio to ESP32's 0-255 PWM scale
    ...
    while True:
        ...
        # --- 3. RED LINE FOLLOWING ---
            ...
            if M["m00"] > 100:
                ...
                #stop_motor()  # CHANGED: For safety, we stop instead of maintaining trajectory when the line is lost.

except KeyboardInterrupt:
    print("\nUser Stopped Program.")
finally:
    stop_motor()
    # CHANGED: Gracefully close the serial connection on exit
